...
export function diagnose() {
  const cfg = PMS_CONFIG;
  console.group('[PMS Adapter Diagnostics]');
  console.log('Mode:', cfg.mode);
  console.log('Cache enabled:', cfg.cache.enabled, `(TTL: ${cfg.cache.ttlMinutes} min)`);
  console.log('Default patient:', cfg.defaultPatientId || '(none)');

  if (cfg.mode === 'opendental') {
    console.log('Open Dental base URL:', cfg.openDental.baseUrl);
    console.log('Direct CORS:', cfg.openDental.directCors);
    console.log('Proxy URL:', cfg.openDental.proxyUrl || '(none)');
  }
  if (cfg.mode === 'dentrix') {
    console.log('Dentrix base URL:', cfg.dentrix.baseUrl);
    console.log('Proxy URL:', cfg.dentrix.proxyUrl || '(none)');
    console.log('API key set:', !!cfg.dentrix.apiKey);
  }
  if (cfg.mode === 'generic') {
    console.log('Generic base URL:', cfg.generic.baseUrl);
    console.log('Endpoints:', cfg.generic.endpoints);
  }
  console.groupEnd();
}
